...
import org.theblackproject.datafactory.util.Xeger;

public class InternetImpl implements Internet {

	private static final String REGEX_DOMAIN = "[a-z0-9]+([\\-\\.]{1}[a-z0-9]+)*";
	...
	private static String[] topLevelDomains = {
			...
			"cz", "de", "dj", "dk", "dm", "do", "dz", "ec", "ee", "eg", "er", "es", "et", "eu", "fi", "fj", "fk", "fm",
			...
			"lc", "li", "lk", "lr", "ls", "lt", "lu", "lv", "ly", "ma", "mc", "md", "me", "mg", "mh", "mk", "ml", "mm",
	...
	public String getDomain() {
		Xeger generator = new Xeger(REGEX_DOMAIN);
